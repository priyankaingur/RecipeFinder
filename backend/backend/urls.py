...
urlpatterns = [
    ...
    path('api/recipes/<int:recipe_id>/nutrients',RapidApiRecipeNutrients.as_view(), name='rapidapi-recipe-nutrients'),
    path('api/recipes/<int:recipe_id>/similar',RapidApiSimilarRecipe.as_view(), name='rapidapi-recipe-similar'),
